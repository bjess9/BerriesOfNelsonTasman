...
class UWA_Admin {
	...
	*/
	public function uwa_admin_main_menu(  ){
		...
		add_menu_page(__('Ultimate Woo Auction', 'woo-ua'), __('Ultimate <br> Woo Auction', 'woo-ua'), 'manage_options', 'uwa_general_setting',  array($this, 'uwa_auction_setting_page_handler'),$menu_icon, 57.77);			
				
		add_submenu_page('uwa_general_setting', __('Settings', 'woo-ua'), __('Settings', 'woo-ua'), 'manage_options', 'uwa_general_setting', array($this, 'uwa_auction_setting_page_handler'));		
				
		add_submenu_page('uwa_general_setting', __('Auctions', 'woo-ua'), __('Auctions', 'woo-ua'), 'manage_options', 'uwa_manage_auctions', array($this, 'uwa_manage_auction_logs_page_handler'));
